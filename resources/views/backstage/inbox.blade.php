@extends('layout.backstage',['title' => 'Home'])
@section('css')
@endsection
@section('breadcrumb')
	收件箱
...
<div class="inbox-mail"> 
   <div class="col-md-4 compose w3layouts"> 
    ...
    <nav class="nav-sidebar"> 
     <ul class="nav tabs"> 
      <li class="active"><a href="#tab1" data-toggle="tab" aria-expanded="true"><i class="fa fa-inbox"></i>Inbox <span>9</span>
      ...
      <li class=""><a href="#tab4" data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i>Draft <span>6</span>
        <div class="clearfix"></div></a></li> 
     ...
     <div class="inbox-right"> 
      <div class="mailbox-content"> 
       ...
       <table class="table"> 
        <tbody> 
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> <span class="fam">Family</span> </td> 
          <td class="march"> in 5 days </td> 
          <td> <i class="fa fa-star-half-o icon-state-warning"></i> </td> 
         </tr> 
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in1.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in2.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in3.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> <span class="fam">Family</span> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in4.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in5.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in6.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> <span class="fam">Family</span> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in7.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> <span class="ur">urgent</span> </td> 
          <td class="march"> in 2 days </td> 
          <td> <i class="fa fa-star-half-o icon-state-warning"></i> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in8.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> </td> 
          <td class="march"> in 2 days </td> 
          <td> <i class="fa fa-star-half-o icon-state-warning"></i> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in9.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> </td> 
          <td class="march"> in 2 days </td> 
          <td> <i class="fa fa-star-half-o icon-state-warning"></i> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in10.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> <span class="mar">Market</span> </td> 
         ...
         <tr class="table-row"> 
          <td class="table-img"> <img src="/backstage/images/in11.jpg" alt="" /> </td> 
          <td class="table-text"> <h6> Lorem ipsum</h6> <p>Nullam quis risus eget urna mollis ornare vel eu leo</p> </td> 
          <td> <span class="ur">urgent</span> </td> 
          <td class="march"> in 1 days </td> 
          <td> <i class="fa fa-star-half-o icon-state-warning"></i> </td> 
