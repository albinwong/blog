		...
		<header class="agileits-box-header clearfix"> 
			...
			<div class="toolbar"> 
				...
				<div class="pull-right"> 
					<div class="btn-group"> 
						<a aria-expanded="false" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown"> Export <i class="fa fa-angle-down"></i> </a> 
			...
			<div class="card-body p-b-20"> 
				<div class="list-group"> 
					<a class="list-group-item media" href=""> 
						<div class="pull-left"> 
							<img class="lg-item-img" src="/backstage/images/in1.jpg" alt="" /> 
						</div> 
					...
					<a class="list-group-item media" href=""> 
						<div class="pull-left"> 
							<img class="lg-item-img" src="/backstage/images/in2.jpg" alt="" /> 
						</div> 
						<div class="media-body"> 
							<div class="pull-left"> 
					...
					<a class="list-group-item media" href=""> 
						<div class="pull-left"> 
							<img class="lg-item-img" src="/backstage/images/in3.jpg" alt="" /> 
						</div> 
						<div class="media-body"> 
							<div class="pull-left"> 
					...
					<a class="list-group-item media" href=""> 
						<div class="pull-left"> 
							<img class="lg-item-img" src="/backstage/images/in4.jpg" alt="" /> 
						</div> 
						<div class="media-body"> 
							<div class="pull-left"> 
...
@endsection
@section('js')
<script src="/backstage/js/raphael-min.js"></script> 
<script src="/backstage/js/morris.js"></script> 
