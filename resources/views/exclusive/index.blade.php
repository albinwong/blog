	...
	<section class="box-content box-1">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="box-item">
						<img src="/exclusive/images/13.jpg" class="img-responsive"/>
						<div class="content">
					...
					<div class="box-item">
						<img src="/exclusive/images/1.jpg" class="img-responsive"/>
						<div class="content">
					...
					<div class="box-item">
						<img src="/exclusive/images/2.jpg" class="img-responsive"/>
						<div class="content">
					...
					<div class="box-item">
						<img src="/exclusive/images/10.jpg" class="img-responsive"/>
						<div class="content">
				...
				<div class="col-md-4">
					<div class="box-item">
						<img src="/exclusive/images/3.jpg" class="img-responsive"/>
						<div class="content">
					...
					<div class="box-item">
						<img src="/exclusive/images/4.jpg" class="img-responsive"/>
						<div class="content">
					...
					<div class="box-item">
						<img src="/exclusive/images/8.jpg" class="img-responsive"/>
						<div class="content">
							<h3>Choosing The Bridesmaids and Groomsmen</h3>
							<p>Suspendisse porttitor sapien ac lectus euismod imperdiet. Curabitur nec nibh at massa pellentesque accumsan eu id nibh. Donec accumsan ut mi.</p>
							<a href="single.html">Read More...</a>
					...
					<div class="box-item">
						<img src="/exclusive/images/11.jpg" class="img-responsive"/>
						<div class="content">
							<h3>She Said Yes!</h3>
							<p>Nunc eu velit metus. Donec in massa libero. Donec bibendum orci a lorem scelerisque luctus. Aliquam et ante quis erat semper pretium. Pellentesque vehicula.</p>
							<a href="single.html">Read More...</a>
				...
				<div class="col-md-4">
					<div class="box-item">
						<img src="/exclusive/images/5.jpg" class="img-responsive"/>
						<div class="content">
							<h3>Choosing The Bridesmaids and Groomsmen</h3>
							<p>Suspendisse porttitor sapien ac lectus euismod imperdiet. Curabitur nec nibh at massa pellentesque accumsan eu id nibh. Donec accumsan ut mi.</p>
							<a href="single.html">Read More...</a>
					...
					<div class="box-item">
						<img src="/exclusive/images/12.jpg" class="img-responsive"/>
						<div class="content">
							<h3>She Said Yes!</h3>
							<p>Nunc eu velit metus. Donec in massa libero. Donec bibendum orci a lorem scelerisque luctus. Aliquam et ante quis erat semper pretium. Pellentesque vehicula.</p>
							<a href="single.html">Read More...</a>
					...
					<div class="box-item">
						<img src="/exclusive/images/6.jpg" class="img-responsive"/>
						<div class="content">
					...
					<div class="box-item">
						<img src="/exclusive/images/7.jpg" class="img-responsive"/>
						<div class="content">
							<h3>Met Dovey’s Parents in Chicago</h3>
							<p>Class aptent taciti urna bibendum id. Duis a commodo lectus. Morbi id purus nec purus feugiat vestibulum. Suspendisse sapien ante, bibendum ac quam quis, imperdiet bibendum sem. Curabitur nibh magna, tristique et convallis…</p>
							<a href="single.html">Read More...</a>
